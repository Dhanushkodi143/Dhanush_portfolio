    ...
    const contactInfo = [
        {
            ...
            link: "https://mail.google.com/mail/?view=cm&fs=1&to=kodidhanush1402@gmail.com",
            icon: (
        ...
        {
            label: "LinkedIn",
            value: "dhanush-kodi1402",
            link: "https://www.linkedin.com/in/dhanush-kodi1402",
            icon: (
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                        ...
                        {contactInfo.map((info, idx) => (
                            ...
                            >
                                ...
                                <div>
                                    ...
                                    {info.link ? (
                                        <a href={info.link} target={info.link.startsWith('http') ? '_blank' : '_self'} rel="noopener noreferrer" style={{ textDecoration: 'none' }}>
                                            <p style={{ fontSize: '1.15rem', fontWeight: 800, color: 'var(--text-primary)', transition: 'color 0.2s' }} onMouseEnter={(e) => e.currentTarget.style.color = 'var(--accent-color)'} onMouseLeave={(e) => e.currentTarget.style.color = 'var(--text-primary)'}>
                                                {info.value}
                                            </p>
                                        </a>
                                    ) : (
